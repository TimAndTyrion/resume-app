...
import {Box, CardContent, Chip, Divider, Grid, List, ListItem, Typography} from "@mui/material";
import {JobHistory} from "./JobData.ts";

export function JobCard({job}: { job: JobHistory }): React.ReactElement {
  return (
